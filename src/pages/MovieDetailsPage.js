...
// Tai su dung 3 func duoi cho gon gang va tiet kiem
              ...
              <div className="" key={item.id}>
                ...
                <div key={item.id} className="w-full aspect-video">
                  <iframe
                    ...
                    title="Transformers: Rise of the Beasts | VIVID Sydney Drone Show | Paramount Pictures Australia"
                    frameBorder="0"
...
function MovieVideos() {
  ...
  // console.log("🚀 ~ file: MovieDetailsPage.js:95 ~ MovieVideos ~ data:", data);
  if (!data) return null;
  const { results } = data;
  if (!results || results.length <= 0) return null;
  return (
